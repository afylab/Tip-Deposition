...
class Sputerring_Deposition_Test(CalibrationRecipe):
    """
    ...
    def proceed(self):
        ...
        self.trackVariable('Power', 'dcxs_power', 'output_act_p', units='W')
        self.trackVariable('Setpoint power', 'dcxs_power', 'output_set', units='W')
        self.trackVariable('Power', 'dcxs_power', 'output_act_v', units='V')
        self.trackVariable('Power', 'dcxs_power', 'output_act_i', units='mA')
...
class Sputtering_Manual_Calibration(CalibrationRecipe):
    """
...
class Sputtering_Test(CalibrationRecipe):
    ...
    def proceed(self):
        ...
        self.trackVariable('Deposition Rate', 'ftm_server', 'get_sensor_rate', units='(A/s)')
        self.trackVariable('Thickness', 'ftm_server', 'get_sensor_thickness', units='A')
        self.trackVariable('Setpoint power', 'dcxs_power', 'set_setpoint', units='W')
        self.trackVariable('Power', 'dcxs_power', 'power', units='W')
        self.trackVariable('Voltage', 'dcxs_power', 'voltage', units='V')
        self.trackVariable('Current', 'dcxs_power', 'current', units='mA')

        self.trackVariable('Flow rate', 'alicat_mcv', 'get_setpoint', units='SLPM')
        self.wait_for(0.01) # Here because it threw an error one time
        ...
        # step2.add_input_param("Crystal Life", limits=(0,100))
        # yield step2
        step3 = Step(True, "Press to ")
        step2.add_input_param("Setpoint")
        step2.add_input_param("Cooling Water Flow")
        yield step3
