...
# Load the base with: "python -mpyuic5 -x IV_module.ui -o IV_module.py"
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 100, 761, 451))
